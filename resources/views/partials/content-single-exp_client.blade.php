    ...
    <div class="col-12 col-sm-6 col-md-6 col-lg-3">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <h6 class="card-subtitle mb-2 text-muted">{{ get_post_meta(get_the_ID(), 'exp_client_state', true)}},
            {{ $country }}</h6>
          <p class="card-text"></p>
        </div>
        <ul class="list-group list-group-flush">
          <li class="list-group-item"><i class="fas fa-envelope"></i>
            {{ get_post_meta(get_the_ID(), 'exp_client_email', true)}}</li>
          <li class="list-group-item"><i class="fas fa-phone"></i>
            {{ get_post_meta(get_the_ID(), 'exp_client_phone', true)}}</li>
          <li class="list-group-item">
            <i class="fas fa-globe"></i> <a
              href="{{ esc_url( get_post_meta(get_the_ID(), 'exp_client_website', true)) }}" target="_blank">website</a>
          </li>
          <li class="list-group-item">
